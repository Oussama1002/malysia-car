{{--
    Contrat de location — impression sur le formulaire pré-imprimé.

    Cette page ne dessine ni cadre ni libellé : elle ne contient que les valeurs,
    placées aux coordonnées de config/contract_form.php pour tomber dans les
    blancs du papier de l'agence. Avec ?grid=1, une grille centimétrique
    s'affiche pour mesurer un décalage d'imprimante.
--}}
<!DOCTYPE html>
<html lang="fr">
<head>
