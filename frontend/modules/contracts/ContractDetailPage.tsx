      ...
      <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
        ...
        <div className="flex flex-wrap items-start gap-3">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white px-5 py-4 text-right">
            ...
            <GeneratePdfButton kind="contract" entityId={String(c.id ?? id)} className="mt-1 text-2xl font-black text-indigo-700 hover:text-indigo-800 transition-colors disabled:opacity-50" label="Générer PDF" />
          </div>
          {c.status === 'active' && (
            <button
              type="button"
